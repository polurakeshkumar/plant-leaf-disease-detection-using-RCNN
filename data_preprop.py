...
total_files = os.listdir(r"D:\Academics - Btech\4-2\Capstone Project Phase - II\Project\leaf-disease-using-faster-rcnn\train_dir")
...
for filename in tqdm(total_files):
    ...
    if ext=='.jpg' or ext=='.png' or ext=='.PNG' or ext =='.JPG':
        ...
        try:etree = ET.parse(xml_file).getroot()
        except FileNotFoundError:
            print("File not found:", xml_file)
        except PermissionError:
            print("Permission denied to access file:", xml_file)
